...
namespace PackageLicensesMod.VisualStudio
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class PackageReferenceCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static PackageReferenceCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Verify the current thread is the UI thread - the call to AddCommand in PackageReferenceCommand's constructor requires
            // the UI thread.
            ThreadHelper.ThrowIfNotOnUIThread();

            OleMenuCommandService commandService = await package.GetServiceAsync((typeof(IMenuCommandService))) as OleMenuCommandService;
            Instance = new PackageReferenceCommand(package, commandService);
        }
